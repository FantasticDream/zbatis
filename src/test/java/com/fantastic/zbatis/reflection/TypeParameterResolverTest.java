...
import com.fantastic.zbatis.reflection.typeparam.Calculator;
import com.fantastic.zbatis.reflection.typeparam.Level0Mapper;
import com.fantastic.zbatis.reflection.typeparam.Level1Mapper;
import com.fantastic.zbatis.reflection.typeparam.Level2Mapper;
...
class TypeParameterResolverTest {
  ...
  void testReturn_Lv0InnerClass() throws Exception {
    Class<?> clazz = Level0Mapper.Level0InnerMapper.class;
    Method method = clazz.getMethod("select", Object.class);
    Type result = TypeParameterResolver.resolveReturnType(method, clazz);
  ...
  void testReturn_Subclass() throws Exception {
    Class<?> clazz = Calculator.SubCalculator.class;
